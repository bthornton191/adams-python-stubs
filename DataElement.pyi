from typing import ItemsView, Iterable, KeysView, List, Literal, Optional, ValuesView
...
class DataElementManager(Manager.SubclassManager):
    ...
    def keys(self, *args) -> KeysView[str]: ...
    def values_full(self, *args) -> ValuesView[DataElement]: ...
    def keys_full(self, *args) -> KeysView[str]: ...
    def items_full(self, *args) -> ItemsView[str, DataElement]: ...
