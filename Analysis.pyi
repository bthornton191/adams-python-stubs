...
from typing import ItemsView, Iterable, KeysView, List, OrderedDict, Union, ValuesView
...
class AnalysisManager(Manager.AdamsManager):
    ...
    def values_full(self, *args) -> ValuesView[Analysis]: ...
    def keys_full(self, *args) -> KeysView[str]: ...
    def items_full(self, *args) -> ItemsView[str, Analysis]: ...
