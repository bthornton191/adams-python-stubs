...
class SystemElementManager(Manager.SubclassManager):
    ...
    def values(self) -> ValuesView[SystemElement]: ...
    def keys(self) -> KeysView[str]: ...
    def items(self) -> ItemsView[str, SystemElement]: ...
    def __getitem__(self, name: str) -> SystemElement: ...
    def __iter__(self) -> Iterable[SystemElement]: ...
    def values_full(self) -> ValuesView[SystemElement]: ...
    def keys_full(self) -> KeysView[str]: ...
    def items_full(self) -> ItemsView[str, SystemElement]: ...
