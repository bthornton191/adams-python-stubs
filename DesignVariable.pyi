...
class DesignVariableManager(Manager.SubclassManager):
    ...
    def values_full(self, *args) -> ValuesView[Union[IntegerDesignVariable, RealDesignVariable, StringDesignVariable, ObjectDesignVariable]]: ...
    def keys_full(self, *args) -> KeysView[str]: ...
    def items_full(self, *args) -> ItemsView[str, Union[IntegerDesignVariable, RealDesignVariable, StringDesignVariable, ObjectDesignVariable]]: ...
