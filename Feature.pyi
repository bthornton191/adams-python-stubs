...
class FeatureManager(Manager.SubclassManager):
    ...
    def values(self) -> ValuesView[Feature]: ...
    def keys(self) -> KeysView[str]: ...
    def items(self) -> ItemsView[str, Feature]: ...
    def __getitem__(self, name: str) -> Feature: ...
    def __iter__(self) -> Iterable[Feature]: ...
    def values_full(self) -> ValuesView[Feature]: ...
    def keys_full(self) -> KeysView[str]: ...
    def items_full(self) -> ItemsView[str, Feature]: ...
